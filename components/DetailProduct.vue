        ...
        <div class="container">
            ...
            <div class="flex items-center">
                ...
                <div class="w-1/2 pl-5">
                    <p class="text-xl font-light mb-3">{{ oneProduct.category }}</p>
                    <h1 class="text-4xl font-bold mb-3">{{ oneProduct.name }}</h1>
                    <h3 class="text-4xl font-light mb-3">${{ oneProduct.price }}</h3>
                    <p class="mb-10">{{ oneProduct.description }}</p>
                    <div class="flex flex-col gap-4">
                        <div class="w-full flex items-center gap-2 bg-blue-600 text-white py-5 justify-center rounded-lg cursor-pointer hover:bg-blue-600/80 transition duration-300 relative" @click="addCart">
